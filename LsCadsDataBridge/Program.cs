using LsCadsDataBridge.Example.Endpoints;
using LsCadsDataBridge.Example.Services;
using LsCadsDataBridge.Utils;
using LsCadsDataBridge.Utils.Http;
using LsCadsDataBridge.Utils.Mongo;
using FluentValidation;
using System.Diagnostics.CodeAnalysis;
using LsCadsDataBridge.Config;
using LsCadsDataBridge.Utils.Logging;
using Serilog;
