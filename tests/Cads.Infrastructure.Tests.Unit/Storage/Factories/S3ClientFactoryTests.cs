...
using Cads.Infrastructure.Storage;
using Cads.Infrastructure.Storage.Clients;
using Cads.Infrastructure.Storage.Factories.Implementations;

namespace Cads.Infrastructure.Tests.Unit.Storage.Factories;
...
public class S3ClientFactoryTests
{
    ...
    {
        Action act = () => _clientFactory.AddClientWithCredentials<TestStorageClient>(DefaultBucketName, "INVALID_TEST_ACCESS_KEY", "INVALID_TEST_SECRET_KEY", _defaultAmazonS3Config);
